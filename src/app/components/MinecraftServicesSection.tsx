...
export default function MinecraftServicesSection() {
    return (
        <section className="w-full  py-8 md:py-12 lg:py-16 mt-60 px-2">
            <div className="mx-auto bg-white rounded-[30px] w-full py-8 max-w-[1420px] px-4 md:px-8 lg:px-16">
                <div className="relative flex flex-col items-center gap-8 lg:flex-row lg:gap-12">
              
                    {/* Image Section */}
                    <div className="relative z-10 w-full max-w-[623px] lg:w-1/2 -mt-60 animate-float">
                    ...
                    <div className="relative z-10 flex w-full max-w-[666px] flex-col gap-8 lg:w-1/2 lg:gap-12">
                        ...
                        <div className="flex flex-col gap-4">
                            <HeaderCenter whiteText='Our Minecraft' blueText='Services' variant='light' side  />
