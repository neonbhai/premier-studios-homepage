...
export default function HeroBackground({
    ...
    return (
        <div className="absolute inset-0 m-[17px] overflow-hidden rounded-3xl">
            ...
            <svg
                className="pointer-events-none absolute bottom-0 left-0 z-[2] hidden h-full w-full md:block"
                viewBox="0 0 500 200"
                preserveAspectRatio="none"
                xmlns="http://www.w3.org/2000/svg"
                aria-hidden="true"
            >
                <path d="M0 200 H34 Q30 200 27 197 L0 170 Z" fill="#050505" />
            </svg>

            {/* Responsive opaque SVG wedge matching mobile cut */}
            <svg
                className="pointer-events-none absolute bottom-0 left-0 z-[2] h-full w-full md:hidden"
                viewBox="0 0 361 383"
                preserveAspectRatio="none"
                xmlns="http://www.w3.org/2000/svg"
                aria-hidden="true"
