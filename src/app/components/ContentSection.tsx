...
export default function ContentSection({ reverse }: { reverse: boolean }) {
    return (
        <section className="container mx-auto flex w-full justify-center py-8 md:py-12 lg:py-16">
            <div className="relative w-full px-[1rem] md:px-[2rem] lg:px-[4.25rem]">
                {/* Desktop Layout */}
                <div
                    className={`hidden ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} justify- center relative min-h-[766px] w-full flex-col items-end gap-32 lg:flex`}
                >
