...
export default function HeroContentSection({
    ...
    return (
        <div className="absolute top-[21vh] left-7 z-[2] flex w-[calc(90%-4rem)] flex-col gap-6 sm:top-[32vh] sm:left-8 sm:w-[calc(70%-4rem)] sm:gap-8 md:top-[30vh] md:w-[calc(40%-4rem)] lg:top-[30vh] xl:top-[32.4vh] xl:left-[4.3vw] xl:w-[29.5vw] xl:gap-[3.9vh]">
